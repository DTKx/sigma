...
from sigma import app,db,bcrypt
from sigma.forms import (RegistrationForm,LoginForm,
UpdateAccountForm,PostForm,RequestResetForm,ResetPasswordForm,NiceClassificationForm)
from sigma.models import User,Post
...
#         db.session.add(user)
#         db.session.commit()
#         flash(f'Your account was created, you are now able to login','success')
...
#             picure_file=save_picture(form.picture.data)
#             current_user.image_file=picure_file
...
# @app.route("/user/<string:username>")#home also would work
